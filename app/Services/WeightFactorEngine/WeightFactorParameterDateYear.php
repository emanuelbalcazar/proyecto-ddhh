...
/**
* Implementacion de un calculador para el año de una fecha.
* En dos personas distintas, comprueba que el año de la fecha
* contenga el mismo valor.
*/
class WeightFactorParameterDateYear extends WeightFactorParameterGeneric {
  ...
  */
  public function check($person0, $person1) {
    ...
    $person0_value = explode("-", $person0[$field])[0];
    $person1_value = date("Y", $person1_time);

    //Compruebo si para las dos personas, en el mismo campo, contiene el mismo valor
    return ($person0_value == $person1_value) ? true : false;
