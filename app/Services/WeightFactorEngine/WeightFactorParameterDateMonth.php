...
/**
* Implementacion de un calculador para el mes de una fecha.
* En dos personas distintas, comprueba que el mes de la fecha
* contenga el mismo valor.
*/
class WeightFactorParameterDateMonth extends WeightFactorParameterGeneric {
  ...
  */
  public function check($person0, $person1) {
    ...
    $person0_value = explode("-", $person0[$field])[1];
    $person1_value = date("m", $person1_time);
